...
import { Phone, Clock, CheckCircle, MapPin, Zap, Shield, AlertTriangle, Lightbulb } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import SEO from "@/components/SEO";
import Footer from "@/components/Footer";

export default function ElectricalColumbia1000() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <>
      <SEO
        title="Electrician in Columbia, SC | 24/7 Emergency Electrical Services | Carolina Georgia Services"
        description="Licensed electrician in Columbia, SC. 24/7 emergency electrical repairs, panel upgrades, wiring, lighting, generators, and more. 15-25 minute response. Call (888) 885-7330."
        keywords="electrician Columbia SC, emergency electrician Columbia, electrical repair Columbia, panel upgrade Columbia, electrical services Columbia, generator installation Columbia"
        schema={{
          "@context": "https://schema.org",
          "@type": "Electrician",
          "name": "Carolina Georgia Services - Columbia Electrical",
        ...
        <section className="bg-gradient-to-r from-red-600 to-orange-600 text-white py-16">
          <div className="container text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <span className="text-2xl font-bold">24/7 EMERGENCY ELECTRICAL SERVICE IN COLUMBIA, SC</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Licensed Electrician Services in Columbia, South Carolina
            </h1>
            <p className="text-2xl mb-8 leading-relaxed max-w-4xl">
              Power outage? Circuit breaker tripping? Electrical emergency? Carolina Georgia Services responds in 15-25 minutes with licensed electricians ready to solve any electrical problem. Serving Columbia homes and businesses with professional electrical repairs, panel upgrades, wiring, lighting installation, generator service, and emergency electrical work 24/7/365.
            </p>
        ...
        <section className="py-16 bg-background">
          <div className="container max-w-5xl">
            ...
            <div className="prose prose-lg max-w-none mb-12">
              ...
              <p className="text-lg leading-relaxed text-foreground/90 mb-6">
                Carolina Georgia Services provides fast, reliable electrical services throughout Columbia with licensed electricians available 24/7/365. We maintain fully-equipped service vehicles strategically positioned across Richland County, allowing us to reach your location in 15-25 minutes for emergency electrical repairs. Our electricians carry extensive parts inventory, diagnostic equipment, and safety gear to handle any electrical challenge safely and efficiently.
              </p>
              <p className="text-lg leading-relaxed text-foreground/90 mb-6">
            ...
            {/* Columbia Electrical Challenges */}
            <div className="mb-12">
              <h2 className="text-4xl font-bold mb-6 text-foreground">Why Columbia Homes Face Unique Electrical Challenges</h2>
              <p className="text-lg leading-relaxed text-foreground/90 mb-6">
                Columbia's combination of aging housing stock, severe weather, increasing electrical demands, and outdated electrical systems creates specific challenges that homeowners must understand to protect their families and property. Electrical fires cause millions of dollars in property damage annually in South Carolina, with many incidents traced to preventable electrical problems.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-foreground/90">
                      Many Columbia homes—especially in established neighborhoods like Shandon, Rosewood, and Forest Acres—still have electrical panels installed 30-50 years ago. These outdated panels use obsolete technology like fuse boxes or early circuit breakers that can't safely handle modern electrical loads from computers, large TVs, electric vehicles, and high-efficiency HVAC systems. Federal Pacific and Zinsco panels, common in 1960s-1980s Columbia homes, are known fire hazards that should be replaced immediately.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-foreground/90">
                      Columbia experiences frequent severe thunderstorms, particularly during spring and summer months. Lightning strikes and power grid fluctuations create dangerous electrical surges that can destroy sensitive electronics, damage appliances, and start electrical fires. Without whole-home surge protection, your Columbia home remains vulnerable to thousands of dollars in damage from a single lightning strike or power surge.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-foreground/90">
                      Homes built in Columbia during the 1960s-1970s often contain aluminum wiring, which was popular when copper prices soared. Aluminum wiring is now recognized as a significant fire hazard because it expands and contracts more than copper, causing connections to loosen over time and creating dangerous arcing and overheating. If your Columbia home has aluminum wiring, professional evaluation and remediation are essential for safety.
                    </p>
                  </CardContent>
                </Card>
              </div>
            ...
            <div className="mb-12">
              <h2 className="text-4xl font-bold mb-6 text-foreground">Complete Electrical Services for Columbia Homes & Businesses</h2>
              <p className="text-lg leading-relaxed text-foreground/90 mb-8">
                Carolina Georgia Services provides comprehensive electrical solutions for residential and commercial properties throughout Columbia. Our licensed electricians have the training, experience, and equipment to handle any electrical challenge safely and efficiently, from simple outlet repairs to complex whole-home rewiring projects.
              </p>
              ...
              <div className="space-y-6">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-foreground/90 mb-4">
                      Electrical emergencies create immediate safety hazards that require professional response. A sparking outlet could indicate dangerous wiring faults that might start a fire. A circuit breaker that won't reset suggests serious electrical problems. A complete power loss leaves your family without essential services. When these emergencies strike your Columbia home, you need a licensed electrician immediately—not tomorrow morning.
                    </p>
                    <p className="text-foreground/90 mb-4">
                      Carolina Georgia Services maintains 24/7/365 emergency electrical service throughout Columbia with no overtime charges. Our electricians arrive in 15-25 minutes with diagnostic equipment and parts to identify and fix electrical problems safely. We never compromise on safety, and we always follow proper electrical codes and procedures.
                    </p>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-foreground/90 mb-4">
                      Homes built in Columbia before 1980 often have outdated wiring that doesn't meet modern safety standards. Cloth-insulated wiring, knob-and-tube wiring, and aluminum wiring all present serious fire hazards. Even copper wiring deteriorates over decades, with insulation becoming brittle and connections loosening. If your Columbia home has old wiring, frequent electrical problems, or you're planning major renovations, professional rewiring protects your family and property.
                    </p>
                    <p className="text-foreground/90 mb-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-foreground/90 mb-4">
                      If you're buying an older Columbia home, experiencing frequent electrical problems, or simply want peace of mind about your electrical system's safety, our comprehensive electrical inspections identify potential hazards and code violations. We provide detailed written reports with photographs and recommendations for repairs or upgrades.
                    </p>
                  </CardContent>
                </Card>
              </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-foreground/90">
                          We maintain service vehicles throughout Columbia for rapid response to electrical emergencies. When you call, we dispatch immediately.
                        </p>
                      </div>
                    </div>
                  </CardContent>
            ...
            <div className="bg-gradient-to-r from-red-600 to-orange-600 text-white rounded-lg p-8 text-center">
              <h2 className="text-3xl font-bold mb-4">Need an Electrician in Columbia?</h2>
              <p className="text-xl mb-6">
                24/7 emergency service • 15-25 minute response • Licensed & insured
              </p>
              <Button size="lg" variant="default" className="bg-white text-red-600 hover:bg-gray-100 text-xl px-8 py-6" asChild>
                <a href={phoneLink}>
                  <Phone className="mr-2 h-6 w-6" />
